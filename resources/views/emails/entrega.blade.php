...
@foreach ($msg['correo'] as $e)
  ...
  <p>* {{$msg['motivo']}}</p>
    ...
    <p>Para ingresar al sistema y realizar el seguimiento, hacer click al siguiente enlace:<br><a href="http://industriasordonez.jmefsystems.com" target="_blank"> http://industriasordonez.jmefsystems.com</a></p>

  <p>no lográ ver este correo? <a href="mailto:jhoanespinoza01@gmail.com">Click aquí</a> para envíar un correo al equipo de soporte.</p>
  <!--<div class="yj6qo"></div>
