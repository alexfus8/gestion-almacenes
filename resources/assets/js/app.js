...
Vue.component('consultacompra', require('./components/ConsultaCompra.vue'));
...
Vue.component('reporteindicador1', require('./components/ReporteIndicador1.vue'));
Vue.component('reporteindicador2', require('./components/ReporteIndicador2.vue'));
Vue.component('entregaperfecta_pretest', require('./components/EntregaPerfectaPreTest.vue'));
Vue.component('entregastiempo_pretest', require('./components/EntregasTiempoPreTest.vue'));
