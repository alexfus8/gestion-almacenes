...
<div class="content-wrapper">
    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
            <h1 class="m-0 text-dark">Datos Indicador Entregas Perfectas Pre-Test</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Inicio</a></li>
                <li class="breadcrumb-item active">Datos Indicador Entregas Perfectas Pre-Test</li>
            </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                            ...
                            <div class="row col-md-12">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-sm">
                                        ...
                                        <tbody>
                                            <tr v-for="producto in arrayProductoStock" :key="producto.id">
                                                <td class="center">
                                                ...
                                                <td class="center" v-text="producto.ped_ep"></td>
                                                <td class="center" v-text="producto.tot_pe"></td>
                                                <td class="center" >{{producto.entrega_perfecta_pretest}} %</td>
                                            </tr>                                
                                        </tbody>
                                    </table>
                                </div>
                    ...
                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                        <div class="card-body">
                            ...
                            <div class="input-group input-group-lg mb-3">
                                ...
                                <input type="number" v-model="ped_ep" class="form-control input-lg" placeholder="Ingrese nro de despachos cumplidos a tiempo">                                        
                                <span class="input-group-text" style="color:red;" v-show="ped_ep==''">(*Ingrese)</span> 
                            </div>
                            <div class="input-group input-group-lg mb-3">
                                <div class="input-group-prepend">
                                        <span class="input-group-text">
                                ...
                                <input type="number" v-model="tot_pe" class="form-control input-lg" placeholder="Ingrese nro total despachos requeridos">                                        
                            ...
                            <div class="input-group input-group-lg mb-3">
                                ...
                                <span type="hidden" class="form-control input-lg" for="text-input">{{entrega_perfecta_pretest=((ped_ep/tot_pe)*100).toFixed(2)}} %</span>                                       
                            </div>
    ...
    export default {
        ...
        methods : {
            listarProducto (page,buscar,criterio){
                let me=this;
                var url= '/entrega_perfecta_pretest?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;
                axios.get(url).then(function (response) {
                    var respuesta= response.data;
                    me.arrayProductoStock = respuesta.entrega_perfecta_pretest.data;
            ...
            cargarPdf(){
                window.open('http://localhost:8000/entrega_perfecta_pretest/reporteindicador1','_blank');
            },
            ...
            registrarProducto(){
                ...
                axios.post('/entrega_perfecta_pretest/registrar',{
                    'item': this.item,
                    'fecha_consulta': this.fecha_consulta,
                    'ped_ep': this.ped_ep,
                    'tot_pe': this.tot_pe,
                    'entrega_perfecta_pretest': this.entrega_perfecta_pretest
                }).then(function (response) {
                    me.cerrarModal();
                    me.listarProducto(1,'','fecha_consulta');
                    swal({
                            type: 'success',
                            title: 'Registrado!',
            ...
            actualizarProducto(){
               if (this.validarProducto()){
                ...
                axios.put('/entrega_perfecta_pretest/actualizar',{
                    'item': this.item,
                    'fecha_consulta': this.fecha_consulta,
                    'ped_ep': this.ped_ep,
                    'tot_pe': this.tot_pe,
            ...
            desactivarProducto(id){
               swal({
                ...
                if (result.value) {
                    ...
                    axios.put('/entrega_perfecta_pretest/eliminar',{
                        'id': id
                    }).then(function (response) {
            ...
            validarProducto(){
                ...
                if (this.ped_ep.length==0) this.errorMostrarMsjProducto.push("Salida durante el periodo debe ser un número y no puede estar vacío.");
                ...
                switch(modelo){
                    case "producto":
                    {
                        switch(accion){
                            ...
                            {
                                this.modal = 1;
                                this.tituloModal = 'AGREGAR DATOS DEL INDICADOR 1 PRE - TEST';
                                this.idproducto=0;
                                this.idcategoria=0;
                                this.nombre_categoria='';
                                this.item = '';
                            ...
                            case 'actualizar':
                            {
                                ...
                                this.ped_ep=data['ped_ep'];
                                this.tot_pe=data['tot_pe'];
                                this.entrega_perfecta_pretest= data['entrega_perfecta_pretest'];
                                break;
                            }
                        }
                    }
