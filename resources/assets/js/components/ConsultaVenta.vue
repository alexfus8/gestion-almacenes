                                        ...
                                        <table class="table table-bordered table-striped table-sm">
                                            ...
                                            <tbody>
                                                <tr v-for="venta in arrayVenta" :key="venta.id">
                                                    <td>
                                                        <button type="button" @click="verVenta(venta.id)" class="btn btn-success btn-xs">
                                                        <i class="fa fa-eye"></i>
                                                        </button> &nbsp;
                                                        <button type="button" @click="pdfVenta(venta.id)" class="btn btn-info btn-xs">
...
<script>
    ...
    export default {
        ...
        methods : {
            ...
            cargarPdf(){
                window.open('http://localhost:8000/reporteindicador/reporteIndicador2','_blank');
            },
            pdfVenta(id){
