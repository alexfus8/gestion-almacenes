...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                <h1 class="m-0 text-dark">Indicador Entregas a Tiempo "Pos-Test"</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Inicio</a></li>
                    <li class="breadcrumb-item active">Indicador Entregas a Tiempo "Pos-Test"</li>
                </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    <div class="callout callout-info">
                        <button type="button" @click="cargarPdf()" class="btn btn-info">
                            <i class="far fa-file-pdf"></i>&nbsp;Reporte ET
                        </button>
                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <select class="form-control" v-model="criterio">
                                            <option value="created_at">Fecha de Registro-Entrega</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <table class="table table-bordered table-striped table-sm">
                                        ...
                                        <tbody>
                                            <tr v-for="(producto, index) in arrayProductosTest" :key="producto.id">
                                                ...
                                                <td class="center" v-text="producto.dia_registro_ent"></td>
                                                <td class="center" v-text="producto.cont_tpet"></td>
                                                <td class="center" v-text="producto.cont_tpe"></td>
                                                <td class="center">{{((producto.cont_tpet/producto.cont_tpe)*100).toFixed(2)}} %</td>
                                            </tr>                                
                                        </tbody>
                                    </table>
                                </div>
...
<script>
    export default {
        data (){
            return {
                cantidad_real : '',
                fecha_consulta:'01/04/2019 - 30/04/2019',
                cantidad_inventariada : '',
                vendedor_horas_trabajo: '14',
                cantidad_real:'',
                sdPeriodo:'',
                stockMedio:'',
        ...
        methods : {
            listarProducto (page,buscar,criterio){
                let me=this;
                var url= '/entregas_tiempo_postest?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;
                axios.get(url).then(function (response) {
                    var respuesta= response.data;
                    me.arrayProductosTest = respuesta.pedidos.data;
            ...
            cargarPdf(){
                window.open('http://localhost:8000/entregas_tiempo_postest/reporteIndicador2','_blank');
            },
